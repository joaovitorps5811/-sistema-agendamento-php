...
<div class="card-container">
    ...
    <div class="info-box">
        <h4>Primeiro acesso ao painel?</h4>
        <p>Preencha os campos acima. Seus dados ficarão salvos com criptografia ponta a ponta no DeskTime.</p>
    </div>

    <div class="footer-links">
        Tem uma conta?<a href="/login">Faça o Login</a>
    </div>
